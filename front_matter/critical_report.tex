...
\lastname{Werner}
\title{Six fugues}
\subtitle{(US-DMu 269477)}
\scoring{2 vl, vla, vlc, (cemb)}
\maketitle
...
This edition bases upon a print by Artaria (Vienna, 1804), which has been archived by the Duke University Libaries. The digital version of the print is available at \url{https://idn.duke.edu/ark:/87924/r3qz22w7k} (siglum 269477; see also RISM ID 990068295).

In general, this edition closely follows the print. Any changes that were introduced by the editor are indicated by italic type (lyrics, dynamics and directions), parentheses (expressive marks and bass figures) or dashes (slurs and ties). Accidentals are used according to modern conventions. Asterisks denote changes that are clarified in the detailed remarks below.\footnote{Abbreviations: cemb, cembalo; Pr, print; r, rest; vl, violin; vla, viola; vlc, violoncello.}
...
\begin{longtable}{lll L{10cm}}
  ...
  \midrule \endhead
  – & –  & cemb & All bass figures were added by the editor. \\
  1 & 35 & vl 2 & 1st note in Pr: b′8. \\
  2 & 10 & vl 1 & 1st quarter in Pr: c′′′ \\
  3 & 1  & vl 1 & 4th eighth in Pr: c″8 \\
    & 1  & vl 2 & 6th to 8th eighth in Pr: g′8–es′8–d′8 \\
    & 46 & vlc  & 4th eighth in Pr: d16–es16 \\
  6 & 51 & vl 1 & 2nd quarter in Pr: f″8–d″16–f″16 \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/werner-six-fugues}. Your help will be greatly appreciated.
